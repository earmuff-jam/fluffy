...
const BIO_PLACEHOLDER =
  "Add short bio about yourself to let others know details about you.";

interface IUserDetailsProps {
  data: UserDemographicsType;
}

const UserDetails: React.FunctionComponent<IUserDetailsProps> = ({ data }) => {
  return (
    <Paper
      sx={{
        padding: "1rem",
    ...
    >
      ...
      <Stack spacing={1} data-tour="profile-4">
        ...
        <Stack direction={"row"} alignItems={"center"} spacing={1}>
          ...
          <Typography variant="subtitle2" color="text.secondary">
            {data?.grid_view
              ? "Viewing Assets as Grid"
              : "Viewing Assets as List"}
          </Typography>
        </Stack>
        <Stack direction={"row"} alignItems={"center"} spacing={1}>
