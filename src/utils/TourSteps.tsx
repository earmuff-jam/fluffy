...
import { TourStepsType } from '@utils/types';
 ...
 */
const derieveTourSteps = (staticSteps: TourStepsType[], prefix: string) => {
...
const OVERVIEW_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
        title:
...
const ASSETS_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
...
const CATEGORIES_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
...
const MAINTENANCE_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
...
const REPORTS_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
        title:
...
const PROFILE_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
        title:
...
const RECENT_ACTIVITIES_PAGE_TOUR_STEPS: TourStepsType[] = [
    {
        title:
...
const PERSONAL_NOTES_PAGE_DATA_TOUR_STEPS: TourStepsType[] = [
    {
...
const SELECTED_CATEGORY_PAGE_DATA_TOUR_STEPS: TourStepsType[] = [
    {
...
const SELECTED_MAINTENANCE_PLAN_PAGE_DATA_TOUR_STEPS: TourStepsType[] = [
    {
