...
interface IFilterAndSortMenuProps {
...
const FilterAndSortMenu: React.FunctionComponent<IFilterAndSortMenuProps> = ({
  sortingOrder,
  setSortingOrder,
  selectedFilter,
  setSelectedFilter,
  ...
  const handleMenuItemClick = (optionLabel: string) => {
    ...
    <Stack sx={{ flexDirection: "row", gap: "1rem", mb: "1rem" }}>
      ...
      >
        <Paper sx={{ width: 200 }}>
          <Typography
            variant="h6"
            sx={{ paddingLeft: "0.5rem", paddingTop: "0.5rem" }}
          >
            Filter results:
          </Typography>
